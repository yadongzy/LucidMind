...
function updateThinkingVisibility() {
    thinkingToggle.classList.toggle('on', thinkingVisible);
    document.querySelectorAll('.thinking-box').forEach(box => {
        box.style.display = thinkingVisible ? 'block' : 'none';
    });
}

thinkingToggle.addEventListener('click', () => {
    thinkingVisible = !thinkingVisible;
    localStorage.setItem('lucid_thinking', thinkingVisible);
